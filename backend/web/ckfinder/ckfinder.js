 ...
 (function() {
    ...
    function e(f, g, h) {
        ...
        function(i) {
            ...
            f.config = g.config;
            g.aG['foldertree.foldertree'].on('afterAddFolder', 
            function(j) {
                j.removeListener();
                if (h)
                h(f);
    ...
    d.prototype = {
        ...
        addFileContextMenuOption: function(f, g, h) {
            ...
            f.group = 'file1';
            i.gp(j, f);
            i.aG['filesview.filesview'].on('beforeContextMenu', 
            function m(k) {
                if (h) {
        ...
        addFolderDropMenuOption: function(f, g, h) {
            ...
            i.aG['foldertree.foldertree'].on('beforeDropMenu', 
            function m(l) {
        ...
        replaceUploadForm: function(f, g, h, i) {
            ...
            return;
            j.dC = i;
            j.aG['formpanel.formpanel'].on('beforeUploadFileForm', 
            function(k) {
                if (k.data.step != 2)
                return;
                if (i > j.dC)
        ...
        refreshOpenedFolder: function() {
            var f = b(this.id),
            g = f.aG['filesview.filesview'].tools
            .currentFolder();
    ...
    (function() {
        ...
        CKFinder.prototype = {
            ...
            popup: function(g, h) {
                ...
                j = parseInt(
                (window.screen.width - g) / 2, 10),
                k = 'location=no,menubar=no,toolbar=no,dependent=yes,minimizable=no,modal=yes,alwaysRaised=yes,resizable=yes,width='
                + g + ',height=' + h + ',top=' + i + ',left=' + j,
    ...
    (function() {
        ...
        a.tools = {
            ...
            cssStyleToDomStyle: (function() {
                ...
                k = typeof j.cssFloat != 'undefined' ? 'cssFloat'
    ...
    k.prototype, 
    {
        ...
        ir: function(l) {
            ...
            o = G.getDocument().bH(),
            p = G
            .getDocument().$.compatMode == 'BackCompat',
            q = G
            .getDocument();
    ...
    (function() {
        ...
        a.nd = "\x6c\x6f";
        a.jG = "\x68\x6f";
        a.hf = new window["\122\145\147\x45\170\160"](
        "\x5e\x77\x77\167\x5c\x2e");
        ...
        a.aL.Folder.prototype = {
            ...
            getChildren: function(s, t) {
                ...
                function(y) {
                    ...
                    u.hm = true;
                    var A = y
                    .selectNodes('Connector/Folders/Folder'),
                    B = [];
                    u.childFolders = null;
                    for (var C = 0; C < A.length; C++) {
                        ...
                        .getNamedItem('name').value,
                        E = A[C].attributes
                        .getNamedItem('hasChildren').value == 'true',
                        F = parseInt(
                        A[C].attributes
                        .getNamedItem('acl').value, 
                        10);
    ...
    (function() {
        ...
        function q() {
            ...
            x.bh('RemoveFolder', 'requestRemoveFolder', 
            function D(z) {
                var A = this,
                B = this.tools.cq(z),
                C = i.extend({},
            ...
            false);
            x.bh('LoadingFolder', 'requestLoadingFolder', 
            function D(z) {
                var A = this,
                B = this.tools.cq(z);
                if (!B)
            ...
            x.bh('ProcessingFolder', ['requestProcessingFolder'], 
            function A(
            z) {
            ...
            x.bh('RepaintFolder', ['requestRepaintFolder'], 
            function A(z) {
                this.oW('beforeRepaintFolder', z.data, 
                function J(B, C) {
                    var K = this;
                    if (B)
                    return undefined;
            ...
            x.bh('AddFolder', 'requestAddFolder', 
            function C(z) {
                var A = this,
                B = {
                ...
                this.oW('beforeAddFolder', B, 
                function M(D, E) {
                    if (D)
                    return;
                    var F = E.folders,
                    G = E.root ? this.tools.cq(E.root)
                    : null,
                    H,
                    I;
                    try {
            ...
            x.dT.push(function(z, A) {
                A.on('afterExpandFolder', 
                function() {
                    A.oW('requestSelectFolderRefresh');

                },
                null, null, 999);
                A.on('successRemoveFolder', 
                function() {
                    A.oW('requestSelectFolderRefresh');

                });
                A.on('successLoadingFolder', 
                function(B) {
                    if (B.data.step == 1)
                    A.oW('requestSelectFolderRefresh');
            ...
            x.tools.jL = function G(z, A, B) {
                var C = this.ib,
                D = this.ib.app.getResourceType(z)
                .getRootFolder(),
                E = D,
                F = A == '/' ? [] : A.split(
                '/').slice(1);
    ...
    (function() {
            ...
            bz: function M(K) {
                ...
                function P(N) {
                    if (N.data.space == 'mainMiddle') {
                        ...
                        if (!g)
                        O = u[0] + u[3];
                        N.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='message_content' style='display:none'></h4><div class='files_thumbnails fake no_list' role='list'></div>"
                        + O + '</div>';
        ...
        function z() {
            ...
            L = "Please visit the CKFinder web site to obtain a valid license.",
            M = "This is the DEMO version of CKFinder." + L,
            N = "Product license has expired." + L;
            ...
            K.bh('ProcessingFile', ['requestProcessingFile'], 
            function S(P) {
                ...
                true);
                this.oW('beforeProcessingFile', R, 
                function X(T, U) {
                    if (T)
                    return;
                    try {
            ...
            K.bh('RepaintFile', ['requestRepaintFile'], 
            function S(P) {
                var Q = this.tools.bZ(P),
                R = i.extend({},
                P.data, {
            ...
            K.bh('HoverFile', ['mouseover', 'mouseout'], 
            function S(P) {
            ...
            function eS(P) {
                ...
                W = this.app.config.showContextMenuArrow ? 1
                : 0;
            ...
            K.bh('SelectFile', ['click', 'requestSelectFile'], 
            function U(P) {
                var Q = this.tools.bZ(P),
                R = P.name == 'click',
                S = P.data
            ...
            function T(P) {
                var Q = this,
                R = a.aG.bX['foldertree.foldertree'].tools
                .cq(P),
                S = i.extend({},
                P.data, {
                    folder: R
        ...
        oU: function() {
            ...
            if (!p) {
                if (this.lE || this.css.length) {
                    ...
                    t = r
                    .getParent().getAttribute('class').split(' ')[0],
                    u = r
            ...
            bz: function(r) {
                ...
                function(t) {
                    if (t.data.space == 'mainTop') {
                        ...
                        '</span>');
                        var x = r.dh.fk,
                        y = r.config.toolbar instanceof Array ? r.config.toolbar
                        : r.config['toolbar_'
                        + r.config.toolbar];
                        for (var z = 0; z < y.length; z++) {
                            var A = y[z];
    ...
    (function() {
        ...
        function p() {
            ...
            function r() {
                var u = "RMRHY5Q4S,GGYXTSBLA,QS8F4ZFUJ";
                /*####aconf### 疑似序列号*/
    ...
    (function() {
        function p(q, r) {
            ...
            Q = (function() {
                ...
                .test(ar)
                : /win/.test(aq),
                at = ar ? /mac/.test(ar) : /mac/
                .test(aq),
                au = /webkit/.test(aq) ? parseFloat(aq
                .replace(/^.*webkit\/(\d+(\.\d+)?).*$/, '$1')) : false,
                av = !+'\v1',
                aw = [
                0, 0, 0],
                ax = null;
                ...
                function() {
                    ...
                    function() {
                        ...
                        u) {
                            ...
                            if (v) {
                                var w = v.attributes
                                .getNamedItem('sessionCookieName'),
                                x = v.attributes
    ...
    (function() {
        ...
        function t(w, x) {
            ...
            F = 0,
            G = w
            .getDocument().getById('ckf_cancelUpload'),
            H = false,
            I = 0,
            J = [],
        ...
        function v(w, x) {
            ...
            if (!E || !z.getResourceType().isExtensionAllowed(E)) {
                //aconf
                //alert(z.name);
                //alert(b("images").getResourceType().isExtensionAllowed(E));
                //alert(D[0]);
                C.mD(w.app.lang.UploadExtIncorrect + "ssss");
                    ...
                    exec: function(w) {
                        /*	if (a.bF
															...
															w
																	.msgDialog(
																			'',
																			"This function is disabled in the demo version of CKFinder.<br>Please visit the <a href='http://cksource.com/ckfinder'>CKFinder web site</a> to obtain a valid license.</div>");
														else {*/
                        var x = w.aV;
                        if (!x)
                        return;
    ...
    (function() {
        ...
        D = function(P) {
            ...
            if (!C) {
                ...
                if (f.ie6Compat) {
                    ...
                    U = "<html><body style=\\'background-color:"
                    + R + ";\\'></body></html>";
                    S
        ...
        a.application.prototype, 
        {
            openDialog: function(P, Q, R) {
                ...
                a.scriptLoader.load(a.getUrl(S), 
                function() {
    ...
    (function() {
        ...
        'maximize', 
        {
            bz: function(v) {
                ...
                && new k(
                a.document.getWindow().$.frameElement),
                A = [
                0, 0, 0, 0],
                B = {},
                C,
    ...
    (function() {
        return {
            dQ: function(p) {
                ...
                || 'kama',
                A = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd"><html lang="'
                + p.lang.LangCode
                + '" dir="'
                + p.lang.dir
                + '">'
                ...
                + (p.config.sidebarWidth ? ' style="width: '
                + i
    ...
    (function() {
        ...
        q = "</div>",
        r = p
        + "TIPS: The file operation is time-consuming work. Please be patient."
        + q,
        s = p
        + ""
        /*"CKFinder Developer License<br/>Licensed to: "*/
        ;
        function t(v, w) {
            var x = 0,
            y = 0;
